...
4. **LLM Integration** — Direct REST API integration with Gemini API (`gemini-2.5-flash`) using `responseMimeType: "application/json"` for structured judgment calls and low temperature (0.2) for explainable, consistent evaluation.
